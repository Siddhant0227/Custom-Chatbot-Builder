    ...
    <>
      <div className="login-container">
        ...
        <div className={`login-card ${isRegistering ? 'register-mode' : 'login-mode'}`}>
          ...
          {/* Right Panel - Contains the actual Login/Register Forms */}
